...
// detect_platform.hpp - Platform auto-detection for disc images

#ifndef CHDLITE_DETECT_PLATFORM_HPP
#define CHDLITE_DETECT_PLATFORM_HPP
...
#endif // CHDLITE_DETECT_PLATFORM_HPP
